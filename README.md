# Проект: Место /фронтэнд и бэкэнд/ 
__________________ 
 
 
  На сайте и сервере представлены фото различных мест и посетителям предлагается оценить эти фото поставив лайк. 
...
[Указанный выше сверстанный сайт "Mesto"](https://vvs-mesto.nomoredomains.club) или (https://178.154.230.167) 
